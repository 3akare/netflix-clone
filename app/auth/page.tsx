      ...
      <div className="bg-black size-full md:bg-opacity-50">
        <nav className="p-5">
          ...
          <div className="flex justify-center">
            <form
              className="bg-black bg-opacity-70 p-8 self-center mt-2 md:w-2/5 md:max-w-md rounded-md w-full"
              onSubmit={(event) => {
            ...
            >
              ...
              <div className="flex flex-row items-center gap-4 mt-8 justify-center">
                <button className="bg-white size-10 rounded-full flex justify-center items-center cursor-pointer hover:opacity-80 transition">
                  <FcGoogle size={20} />
                </button>
                <button className="bg-white size-10 rounded-full flex justify-center items-center cursor-pointer hover:opacity-80 transition">
                  <FaGithub size={20} />
